...
- (void)prepareMTGifHead{
    ...
    if (_isHaveTitle) {
        ...
        self.titleLabel.frame = CGRectMake((MTScreenSize().width-(_space+_normalImageWidth+labelWidth))/2+_normalImageWidth+_space, (self.mj_h-(2*_lablHeight+_space))/2, labelWidth, _lablHeight);
        ...
        //上下居中
        self.hintLabel.frame = CGRectMake(_space, CGRectGetHeight(self.frame)-_lablHeight-_space, MTScreenSize().width-2*_space, _lablHeight);
    }
