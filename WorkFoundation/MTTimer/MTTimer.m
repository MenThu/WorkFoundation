...
+ (MTTimer *)createWith:(MTTimerInfo *)timerInfo{
    ...
    timerManager.timer = [NSTimer scheduledTimerWithTimeInterval:timerInfo.timeInterval target:weakTimer selector:@selector(countFunc) userInfo:nil repeats:YES];
